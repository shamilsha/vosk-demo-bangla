...
data class EndpointConfig(
    var rule1: EndpointRule = EndpointRule(false, 1.0f, 0.0f),
    var rule2: EndpointRule = EndpointRule(true, 0.7f, 0.0f),
...
data class OnlineRecognizerConfig(
    ...
    var maxActivePaths: Int = 10,
    var hotwordsFile: String = "",
    var hotwordsScore: Float = 1.5f,
    var ruleFsts: String = "",
    var ruleFars: String = "",
    var blankPenalty: Float = 1.0f,
)
